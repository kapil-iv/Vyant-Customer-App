...
export function AuthPage() {
  ...
  return (
    <section className="mx-auto max-w-md rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      <h1 className="text-xl font-semibold text-slate-900">{mode === "login" ? "Login to Continue Checkout" : "Create Account"}</h1>
      <p className="mt-1 text-sm text-slate-600">You can browse and add to cart without login. Login is only required for checkout.</p>
